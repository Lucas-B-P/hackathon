...
export const clientes = [
...

  {
    ...
    pets: 1,
    ultimaCompra: "09/08/2026",
    ultimoAtendimento: "09/08/2026",
    status: "Ativo",
  },
...
export const pets = [
  {
    ...
    tutor: "João Carlos Ferreira",
    tutorId: 1,
    idade: "3 anos",
    sexo: "Macho",
    nascimento: "10/05/2023",
    peso: "28 kg",
    ultimoAtendimento: "08/08/2026",
  },
...

  {
    ...
    especie: "Gato",
    raca: "Maine Coon",
    tutor: "Fernando Alves",
    tutorId: 5,
    idade: "4 anos",
    sexo: "Macho",
    nascimento: "03/02/2022",
    peso: "8 kg",
    ultimoAtendimento: "12/08/2026",
  },

  {
    ...
    especie: "Cão",
    raca: "Labrador",
    tutor: "Camila Rodrigues",
    tutorId: 6,
    idade: "2 anos",
    sexo: "Macho",
    nascimento: "19/09/2023",
    peso: "30 kg",
    ultimoAtendimento: "09/08/2026",
  },
...
export const produtos = [
  ...
  {
    id: 2,
    nome: "Shampoo Neutro para Cães 500ml",
    sku: "SHP-002",
    categoria: "Higiene",
    estoque: 8,
    estoqueMin: 15,
  ...
  {
    id: 6,
    nome: "Tapete Higiênico c/30 unid.",
    sku: "TAP-006",
    categoria: "Higiene",
    estoque: 0,
    estoqueMin: 5,
...
export const servicos = [
...

  {
    id: 2,
    nome: "Tosa",
    descricao: "Tosa completa no padrão da raça",
    duracao: "2h",
    preco: 65.0,
    funcionario: "Carlos Tosador",
    status: "Ativo",
  },

  {
    id: 3,
    nome: "Banho + Tosa",
    descricao: "Banho completo + tosa padrão",
    duracao: "2h30",
    preco: 85.0,
    funcionario: "Ana Tosadora",
    status: "Ativo",
...

  {
    id: 4,
    nome: "Tosa Higiênica",
    descricao: "Limpeza das áreas íntimas",
    duracao: "30min",
    preco: 25.0,
    funcionario: "Carlos Tosador",
    status: "Ativo",
...

  {
    ...
    duracao: "1h",
    preco: 120.0,
    funcionario: "Dra. Beatriz Santos",
    status: "Ativo",
  },
...
export const funcionarios = [
  {
    ...
    cargo: "Proprietário",
    telefone: "(11) 99234-5678",
    email: "joao@patinhaspetshop.com.br",
    status: "Ativo",
  },

  {
    ...
    email: "fernanda@patinhaspetshop.com.br",
    status: "Ativo",
  },

  {
    ...
    email: "ana@patinhaspetshop.com.br",
    status: "Ativo",
  },

  {
    ...
    email: "carlos@patinhaspetshop.com.br",
    status: "Ativo",
  },

  {
    ...
    email: "beatriz@patinhaspetshop.com.br",
    status: "Ativo",
  },

  {
    ...
    email: "ricardo@patinhaspetshop.com.br",
    status: "Ativo",
  },

  {
    id: 7,
    nome: "Patrícia Atendente",
    cargo: "Atendente",
    telefone: "(11) 99666-7788",
    email: "patricia@patinhaspetshop.com.br",
    status: "Inativo",
  },
]
...
export const movimentacoesEstoque = [
  {
    id: 1,
    produto: "Ração Premium Golden 15kg",
    tipo: "Entrada",
    quantidade: 20,
  ...
  {
    id: 2,
    produto: "Shampoo Neutro 500ml",
    tipo: "Saída",
    quantidade: 3,
    motivo: "Venda PDV",
    usuario: "Ricardo Caixa",
    data: "12/08/2026",
  },

  {
    id: 3,
    produto: "Tapete Higiênico c/30",
    tipo: "Saída",
    quantidade: 5,
    motivo: "Venda PDV",
    usuario: "Ricardo Caixa",
  ...
  {
    id: 5,
    produto: "Ração Gatos Whiskas 3kg",
    tipo: "Entrada",
    quantidade: 12,
    motivo: "Compra fornecedor",
...
export const contasPagar = [
  {
    id: 1,
    descricao: "Aluguel — Vila Madalena",
  ...
  {
    id: 2,
    descricao: "Fornecedor PetNutri Ltda.",
    categoria: "Estoque",
    valor: 1890.0,
...
export const pedidosCliente = [
  {
    id: "#1042",
    data: "10/08/2026",
    produtos: "Ração Premium 15kg, Brinquedo Kong",
    valor: 189.8,
    status: "Entregue",
  },

  {
    id: "#1038",
    data: "01/08/2026",
    produtos: "Shampoo Neutro, Tapete Higiênico",
    valor: 69.8,
    status: "Entregue",
  },
