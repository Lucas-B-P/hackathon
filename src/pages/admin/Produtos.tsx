            ...
            {filtered.map((p) => {
              ...
              return (
                ...
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      {low && (
                        <AlertTriangle
                          size={13}
                          className={zero ? "text-red-500" : "text-orange-400"}
                        />
                      )}
                  ...
                  <td className="hidden md:table-cell px-4 py-3 font-mono text-xs text-[#6b7280]">
                    {p.sku}
                  </td>
                  <td className="px-4 py-3">
                    <span className="text-xs bg-[#f3f4f6] text-[#374151] px-2 py-0.5 rounded-full">
                      {p.category}
                    </span>
                  </td>
                  <td className="px-4 py-3">
                  ...
                  <td className="hidden md:table-cell px-4 py-3 text-xs text-[#9ca3af]">
                    {p.minimum_stock}
                  </td>
                  <td className="hidden md:table-cell px-4 py-3 text-xs text-[#6b7280]">
