  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#16a34a] to-[#15803d] rounded-2xl p-4 md:p-8 text-white">
        ...
        <h1 className="text-3xl font-bold" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Olá, {TUTOR}! 🐾</h1>
        <p className="text-green-100 mt-2">Bem-vindo de volta ao Patinhas Pet Shop. Seus pets estão esperando por você.</p>
      </div>
